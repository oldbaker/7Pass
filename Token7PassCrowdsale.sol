...
import "./Token7Pass.sol";

/*
* @title 7Pass Crowdsale
*/
...
contract RefundVault is Ownable {
  ...
  function deposit(address investor) onlyOwner public payable {
    ...
    deposited[investor] = deposited[investor].safeAdd(msg.value);
  }
...
contract Token7PassCrowdsale is CappedCrowdsale, FinalizableCrowdsale, RefundableCrowdsale {

  function Token7PassCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _cap, address _wallet) public
  ...
  /*
  * @dev Token Deployment. Automatically called when crowdsale is deployed
  */
  function createTokenContract() internal returns (MintableToken) {
    return new Token7Pass();
  }

/*
  // Override to indicatedefine additional logic about when the crowdsale ends 
  // and does not accept any more contributions
...
*/
  ...
  enum CrowdsaleStage { PreICOStage1, PreICOStage2, PreICOStage3, PreICOStage4, ICO }
  CrowdsaleStage public stage = CrowdsaleStage.PreICOStage1;// Starts presale stage 1 by default
